...
public class BlockTypes {
    ...
    public static final BlockType SAPLING = IntBlock.builder().name("sapling").id(6).maxStackSize(64).diggable(true).transparent(true).emitLight(0).filterLight(0).hardness(0f).build();
    ...
    public static final BlockType BED = IntBlock.builder().name("bed").id(26).maxStackSize(1).diggable(true).transparent(true).emitLight(0).filterLight(0).hardness(0.2f).build();
    public static final BlockType POWERED_RAIL = IntBlock.builder().name("golden_rail").id(27).maxStackSize(64).diggable(true).transparent(true).emitLight(0).filterLight(0).hardness(0.7f).build();
    public static final BlockType DETECTOR_RAIL = IntBlock.builder().name("detector_rail").id(28).maxStackSize(64).diggable(true).transparent(true).emitLight(0).filterLight(0).hardness(0.7f).build();
    ...
    public static final BlockType COBWEB = IntBlock.builder().name("web").id(30).maxStackSize(64).diggable(true).transparent(true).emitLight(0).filterLight(0).hardness(4f).build();
    public static final BlockType TALL_GRASS = IntBlock.builder().name("tallgrass").id(31).maxStackSize(64).diggable(true).transparent(true).emitLight(0).filterLight(0).hardness(0f).build();
    public static final BlockType DEAD_BUSH = IntBlock.builder().name("deadbush").id(32).maxStackSize(64).diggable(true).transparent(true).emitLight(0).filterLight(0).hardness(0f).build();
    ...
    public static final BlockType WOOL = IntBlock.builder().name("wool").id(35).maxStackSize(64).diggable(true).transparent(false).emitLight(0).filterLight(15).hardness(0.8f).metadataClass(Dyed.class).flammable(true).defaultMetadata(Dyed.of(DyeColor.WHITE)).build();
    public static final BlockType DANDELION = IntBlock.builder().name("yellow_flower").id(37).maxStackSize(64).diggable(true).transparent(true).emitLight(0).filterLight(0).hardness(0f).build();
    public static final BlockType FLOWER = IntBlock.builder().name("red_flower").id(38).maxStackSize(64).diggable(true).transparent(true).emitLight(0).filterLight(0).hardness(0f).build();
    ...
    public static final BlockType RED_MUSHROOM = IntBlock.builder().name("red_mushroom").id(40).maxStackSize(64).diggable(true).transparent(false).emitLight(1).filterLight(15).hardness(0f).build();
    ...
    public static final BlockType TORCH = IntBlock.builder().name("torch").id(50).maxStackSize(64).diggable(true).transparent(true).emitLight(14).filterLight(0).hardness(0f).build();
    public static final BlockType FIRE = IntBlock.builder().name("fire").id(51).maxStackSize(0).diggable(true).transparent(true).emitLight(15).filterLight(0).hardness(0f).build();
    ...
    public static final BlockType CROPS = IntBlock.builder().name("wheat").id(59).maxStackSize(0).diggable(true).transparent(false).emitLight(0).filterLight(15).hardness(0f).metadataClass(Crops.class).build();
    ...
    public static final BlockType RAIL = IntBlock.builder().name("rail").id(66).maxStackSize(64).diggable(true).transparent(true).emitLight(0).filterLight(0).hardness(0.7f).build();
    ...
    public static final BlockType LEVER = IntBlock.builder().name("lever").id(69).maxStackSize(64).diggable(true).transparent(true).emitLight(0).filterLight(0).hardness(0.5f).build();
    ...
    public static final BlockType REDSTONE_TORCH = IntBlock.builder().name("unlit_redstone_torch").id(75).maxStackSize(64).diggable(true).transparent(true).emitLight(7).filterLight(0).hardness(0f).build();
    public static final BlockType REDSTONE_TORCH_ACTIVE = IntBlock.builder().name("lit_redstone_torch").id(76).maxStackSize(64).diggable(true).transparent(true).emitLight(7).filterLight(0).hardness(0f).build();
    public static final BlockType STONE_BUTTON = IntBlock.builder().name("stone_button").id(77).maxStackSize(64).diggable(true).transparent(true).emitLight(0).filterLight(0).hardness(0.5f).build();
    public static final BlockType TOP_SNOW = IntBlock.builder().name("snow_layer").id(78).maxStackSize(64).diggable(true).transparent(true).emitLight(0).filterLight(0).hardness(0.1f).metadataClass(TopSnow.class).build();
    ...
    public static final BlockType SUGAR_CANE = IntBlock.builder().name("reeds").id(83).maxStackSize(64).diggable(true).transparent(true).emitLight(0).filterLight(0).hardness(0f).build();
    ...
    public static final BlockType PUMPKIN_STEM = IntBlock.builder().name("pumpkin_stem").id(104).maxStackSize(64).diggable(true).transparent(true).emitLight(0).filterLight(0).hardness(0f).metadataClass(Crops.class).build();
    public static final BlockType MELON_STEM = IntBlock.builder().name("melon_stem").id(105).maxStackSize(64).diggable(true).transparent(true).emitLight(0).filterLight(0).hardness(0f).metadataClass(Crops.class).build();
    public static final BlockType VINES = IntBlock.builder().name("vine").id(106).maxStackSize(64).diggable(true).transparent(true).emitLight(0).filterLight(0).hardness(0.2f).build();
    ...
    public static final BlockType LILY_PAD = IntBlock.builder().name("waterlily").id(111).maxStackSize(64).diggable(true).transparent(true).emitLight(0).filterLight(0).hardness(0f).build();
    ...
    public static final BlockType NETHER_WART = IntBlock.builder().name("nether_wart").id(115).maxStackSize(64).diggable(true).transparent(true).emitLight(0).filterLight(0).hardness(0f).build();
    ...
    public static final BlockType ACTIVATOR_RAIL = IntBlock.builder().name("activator_rail").id(126).maxStackSize(64).diggable(true).transparent(true).emitLight(0).filterLight(0).hardness(0.7f).build();
    ...
    public static final BlockType TRIPWIRE_HOOK = IntBlock.builder().name("tripwire_hook").id(131).maxStackSize(64).diggable(true).transparent(true).emitLight(0).filterLight(0).hardness(0f).build();
    public static final BlockType TRIPWIRE = IntBlock.builder().name("tripwire").id(132).maxStackSize(64).diggable(true).transparent(true).emitLight(0).filterLight(0).hardness(0f).build();
    ...
    public static final BlockType FLOWER_POT = IntBlock.builder().name("flower_pot").id(140).maxStackSize(64).diggable(true).transparent(true).emitLight(0).filterLight(0).hardness(0f).metadataClass(FlowerpotBlockEntity.class).build();
    public static final BlockType CARROTS = IntBlock.builder().name("carrots").id(141).maxStackSize(64).diggable(true).transparent(false).emitLight(0).filterLight(15).hardness(0f).metadataClass(Crops.class).build();
    public static final BlockType POTATO = IntBlock.builder().name("potatoes").id(142).maxStackSize(64).diggable(true).transparent(false).emitLight(0).filterLight(15).hardness(0f).metadataClass(Crops.class).build();
    public static final BlockType WOODEN_BUTTON = IntBlock.builder().name("wooden_button").id(143).maxStackSize(64).diggable(true).transparent(true).emitLight(0).filterLight(0).hardness(0.5f).build();
    public static final BlockType MOB_HEAD = IntBlock.builder().name("skull").id(144).maxStackSize(64).diggable(true).transparent(true).emitLight(0).filterLight(0).hardness(1f).build();
    ...
    public static final BlockType CARPET = IntBlock.builder().name("carpet").id(171).maxStackSize(64).diggable(true).transparent(true).emitLight(0).filterLight(0).hardness(0.1f).build();
    ...
    public static final BlockType SUNFLOWER = IntBlock.builder().name("double_plant").id(175).maxStackSize(64).diggable(true).transparent(true).emitLight(0).filterLight(0).hardness(0f).build();
    ...
    public static final BlockType ITEM_FRAME = IntBlock.builder().name("frame").id(199).maxStackSize(64).diggable(true).transparent(false).emitLight(0).filterLight(15).hardness(0f).build();
    ...
    public static final BlockType END_ROD = IntBlock.builder().name("end_rod").id(208).maxStackSize(64).diggable(true).transparent(true).emitLight(14).filterLight(0).hardness(0f).build();
    ...
    private static class IntBlock implements BlockType {
        ...
        public IntBlock(int id, String name, int maxStackSize, boolean diggable, boolean transparent, boolean flammable, int emitLight, int filterLight, float hardness, Class<? extends Metadata> aClass, Class<? extends BlockEntity> blockEntityClass, Metadata defaultMetadata) {
            this.id = id;
            this.name = name;
