...
public class BlockBehaviors {
    ...
    static {
        SPECIAL_BEHAVIORS = ImmutableMap.<BlockType, BlockBehavior>builder()
                ...
                .put(BlockTypes.STONE, new DroppableBySpecificToolsBlockBehavior(DroppableBySpecificToolsBlockBehavior.ALL_PICKAXES))
                .put(BlockTypes.COAL_ORE, new DroppableBySpecificToolsBlockBehavior(DroppableBySpecificToolsBlockBehavior.ALL_PICKAXES))
                .put(BlockTypes.COAL_BLOCK, new DroppableBySpecificToolsBlockBehavior(DroppableBySpecificToolsBlockBehavior.ALL_PICKAXES))
                .put(BlockTypes.IRON_ORE, new DroppableBySpecificToolsBlockBehavior(DroppableBySpecificToolsBlockBehavior.ALL_STONE_PICKAXES))
                .put(BlockTypes.IRON_BLOCK, new DroppableBySpecificToolsBlockBehavior(DroppableBySpecificToolsBlockBehavior.ALL_STONE_PICKAXES))
                .put(BlockTypes.GOLD_ORE, new DroppableBySpecificToolsBlockBehavior(DroppableBySpecificToolsBlockBehavior.ALL_IRON_PICKAXES))
                .put(BlockTypes.GOLD_BLOCK, new DroppableBySpecificToolsBlockBehavior(DroppableBySpecificToolsBlockBehavior.ALL_IRON_PICKAXES))
                .put(BlockTypes.LAPIS_LAZULI_ORE, LapisLazuliOreBlockBehavior.INSTANCE)
                .put(BlockTypes.LAPIS_LAZULI_BLOCK, new DroppableBySpecificToolsBlockBehavior(DroppableBySpecificToolsBlockBehavior.ALL_STONE_PICKAXES))
                .put(BlockTypes.DIAMOND_ORE, DiamondOreBlockBehavior.INSTANCE)
                .put(BlockTypes.DIAMOND_BLOCK, new DroppableBySpecificToolsBlockBehavior(DroppableBySpecificToolsBlockBehavior.ALL_IRON_PICKAXES))
                .put(BlockTypes.LEAVES, new DroppableBySpecificToolsBlockBehavior(DroppableBySpecificToolsBlockBehavior.SHEARS_ONLY)) // TODO: Handle this better.
